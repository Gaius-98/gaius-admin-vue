...
export type ControlCfg<T extends ControlType> = 
T extends 'input' ? LCInputCfg :
T extends 'select' ? LCSelectCfg :
T extends 'switch' ? LCSwitchCfg :
T extends 'radio' ? LCRadioCfg :
T extends 'checkbox' ? LCCheckCfg :
T extends 'date' ? LCDateCfg :
T extends 'number' ? LCNumberCfg :
never 
...
export interface LCSelectCfg  extends Partial<Pick<LCBaseCfg,'allowClear'|'bordered'|'disabled'|'dict'>> {
